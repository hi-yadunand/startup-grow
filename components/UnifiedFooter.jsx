...
export default function UnifiedFooter() {
  ...
  useEffect(() => {
    const bodyWrapper = document.querySelector("#smooth-content .body-wrapper");
    ...
    footerMount.className = "startupgrow-footer-mount";
    bodyWrapper.appendChild(footerMount);
    setMountNode(footerMount);
    ...
    window.setTimeout(refreshScroll, 120);
  ...
  return createPortal(<FooterContent />, mountNode);
}
