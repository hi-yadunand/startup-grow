    ...
    <div id="smooth-content">
      <div class="body-wrapper body-corporate-agency">
        ...
        <main>
          ...
          <div class="counter-area"><div class="counter-area-inner"><div class="thumb"><img src="${onlineImages.marketingMeeting}" alt="Startup team planning digital growth"></div><div class="counter-wrapper-box"><div class="counter-wrapper"><div class="thumb overflow-hidden"><img src="${onlineImages.analyticsDashboard}" data-speed="0.9" alt="Analytics dashboard showing growth metrics"></div><div class="counter-box"><h2 class="text has_fade_anim">We provide 6 core <br>digital services</h2><h2 class="number wc-counter has_fade_anim">6</h2></div><div class="counter-box dark"><h2 class="text has_fade_anim">We support <br>startups with simple <br>growth systems</h2><h2 class="number wc-counter has_fade_anim">1</h2></div><div class="thumb overflow-hidden"><img src="${onlineImages.socialPlanning}" data-speed="0.9" alt="Digital marketing planning workspace"></div></div></div></div></div>



          <section class="awards-area"><div class="container"><div class="awards-area-inner section-spacing"><div class="section-header"><div class="section-title-wrapper"><div class="subtitle-wrapper"><span class="section-subtitle has-left-line">02. Who we are</span></div><div class="title-wrapper"><h2 class="section-title has_fade_anim">We make startup digital growth simple, affordable, and practical!</h2></div></div></div><div class="section-content"><div class="text-wrapper"><p class="text has_fade_anim" data-fade-from="left">We deploy world-class creative design, team on demand. that can design surest measure's of success is when a client partner with more than once build, ship scale your vision most efficient.</p></div><div class="awards-list has_fade_anim"><ul><li><div class="meta"><div class="icon"><img class="show-light" src="/assets/imgs/icon/icon-s-40.webp" alt="icon"><img class="show-dark" src="/assets/imgs/icon/icon-s-40-light.webp" alt="icon"></div><div class="content"><h3 class="number wc-counter">50+</h3><p class="text">projects success rate 99%</p></div></div></li><li><div class="meta"><div class="icon"><img class="show-light" src="/assets/imgs/icon/icon-s-41.webp" alt="icon"><img class="show-dark" src="/assets/imgs/icon/icon-s-41-light.webp" alt="icon"></div><div class="content"><h3 class="number wc-counter">12+</h3><p class="text">award for digital innovation</p></div></div></li></ul></div></div><div class="about-thumbs"><div class="thumb-first"><img src="${onlineImages.collaborativeReview}" class="has_fade_anim" data-fade-from="right" alt="Website and marketing strategy review"></div><div class="thumb-second"><img src="${onlineImages.happyStartupTeam}" class="has_fade_anim" data-fade-from="left" alt="Startup team collaborating"></div></div></div></div></section>



          <section class="about-area container-hd"><div class="about-area-inner"><div class="thumb"><img src="${onlineImages.growthDashboard}" alt="Growth dashboard for startup marketing"></div><div class="section-content"><div class="bg"><img src="${onlineImages.businessStrategy}" alt="Digital strategy planning"></div><div class="section-title-wrapper"><div class="title-wrapper"><h2 class="section-title has_fade_anim">Simple,
                      scalable,
