      ...
      <div className="body-wrapper body-corporate-agency">
        ...
        <main>
          ...
          <section className="contact-area"><div className="container"><div className="contact-area-inner section-spacing"><div className="section-header"><div className="section-title-wrapper"><div className="title-wrapper"><h2 className="section-title large has_fade_anim">We’re ready
                        for you!</h2></div></div><div className="text-wrapper"><p className="text has_fade_anim">The contact module collects startup inquiries and keeps service communication clear.</p></div></div><div className="section-content"><div className="info-box has_fade_anim"><div className="text-wrapper"><p className="text">Tell us your startup needs, and we can plan the right service.</p></div><ul className="contact-list"><li><a href="tel:+881750660600">Indian startups</a></li><li><a href="#">startupgrow@example.com</a></li><li>Digital Solutions <br />for Indian Startups</li></ul></div><div className="contact-wrap has_fade_anim" data-delay="0.30"><form action="#"><div className="contact-formwrap"><div className="contact-formfield"><input type="text" name="Name" id="Name" placeholder="Startup name*" /></div><div className="contact-formfield"><input type="text" name="Email" id="Email" placeholder="Email*" /></div><div className="contact-formfield"><input type="text" name="Phone" id="Phone" placeholder="Phone" /></div><div className="contact-formfield"><input type="text" name="Subject" id="Subject" placeholder="Service*" /></div><div className="contact-formfield messages"><input type="text" name="Messages" id="Messages" placeholder="Message*" /></div></div><div className="submit-btn"><button type="submit" className="wc-btn wc-btn-primary btn-text-flip"><span data-text="Send Message">Send Message</span></button></div></form></div></div></div></div></section>
