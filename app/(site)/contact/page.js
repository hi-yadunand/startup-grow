      ...
      <div className="body-wrapper body-corporate-agency">
        ...
        <main>
          ...
          <section className="hero-area"><div className="container"><div className="hero-area-inner"><div className="section-content"><div className="section-title-wrapper"><div className="title-wrapper"><h1 className="section-title large has_fade_anim">Any
                        ...
                        ask us. <br />
                        this is your
                        contact!</h1></div></div><div className="content-last"><div className="col-first"><div className="image-box overflow-hidden"><img src="assets/imgs/gallery/img-s-106.webp" data-speed="0.9" alt="image" /></div><div className="contact-box"><div className="shape-1"><img src="assets/imgs/shape/img-s-89.webp" alt="shape" /></div><span className="title">Direct contact: </span><p className="link"><a href="#">StartupGrow request</a></p></div></div><div className="col-second"><div className="image-box"><img src="assets/imgs/gallery/img-s-107.webp" alt="image" /></div><div className="image-box overflow-hidden"><img src="assets/imgs/gallery/img-s-108.webp" data-speed="0.9" alt="image" /></div></div></div></div></div></div></section><div className="image-wrapper overflow-hidden"><img className="w-100" src="assets/imgs/gallery/img-s-105.webp" data-speed="0.9" alt="image" /></div>
          

          
          <section className="contact-area"><div className="container"><div className="contact-area-inner section-spacing"><div className="section-header"><div className="section-title-wrapper"><div className="title-wrapper"><h2 className="section-title large has_fade_anim">We’re ready
                        for you!</h2></div></div><div className="text-wrapper"><p className="text has_fade_anim">The contact module collects startup inquiries and keeps service communication clear.</p></div></div><div className="section-content"><div className="info-box has_fade_anim"><div className="text-wrapper"><p className="text">Tell us your startup needs, and we can plan the right service.</p></div><ul className="contact-list"><li><a href="tel:+881750660600">Indian startups</a></li><li><a href="#">startupgrow@example.com</a></li><li>A Digital Solutions Platform <br />for Indian Startups</li></ul></div><div className="contact-wrap has_fade_anim" data-delay="0.30"><form action="#"><div className="contact-formwrap"><div className="contact-formfield"><input type="text" name="Name" id="Name" placeholder="Startup name*" /></div><div className="contact-formfield"><input type="text" name="Email" id="Email" placeholder="Email*" /></div><div className="contact-formfield"><input type="text" name="Phone" id="Phone" placeholder="Phone" /></div><div className="contact-formfield"><input type="text" name="Subject" id="Subject" placeholder="Service*" /></div><div className="contact-formfield messages"><input type="text" name="Messages" id="Messages" placeholder="Message*" /></div></div><div className="submit-btn"><button type="submit" className="wc-btn wc-btn-primary btn-text-flip"><span data-text="Send Message">Send Message</span></button></div></form></div></div></div></div></section>
