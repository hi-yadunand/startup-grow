    ...
    <div id="smooth-content">
      <div class="body-wrapper body-corporate-agency">
        ...
        <main>
          ...
          <div class="featured-post-area"><div class="container"><div class="featured-post-box"><div class="featured-posts"><article class="blog-box has_fade_anim"><a href="/blog"><div class="thumb"><img src="${onlineImages.collaborativeReview}" alt="Startup website planning on a laptop"></div><div class="content"><div class="content-first"><h2 class="title">Building Startup Websites</h2><span class="tag">Features Post <br>Mar - 2024</span></div><div class="icon"><i class="fa-solid fa-arrow-right"></i></div></div></a></article><article class="blog-box has_fade_anim" data-delay="0.30"><a href="/blog"><div class="thumb"><img src="${onlineImages.digitalMarketing}" alt="Digital marketing and traffic dashboard"></div><div class="content"><div class="content-first"><h2 class="title">Marketing Basics</h2><span class="tag">Features Post <br>Feb - 2024</span></div><div class="icon"><i class="fa-solid fa-arrow-right"></i></div></div></a></article><article class="blog-box has_fade_anim" data-delay="0.45" data-on-scroll="0"><a href="/blog"><div class="thumb"><img src="${onlineImages.socialCampaign}" alt="Social media profile and audience planning"></div><div class="content"><div class="content-first"><h2 class="title">Finding Startup Users</h2><span class="tag">Features Post <br>Jan - 2024</span></div><div class="icon"><i class="fa-solid fa-arrow-right"></i></div></div></a></article></div></div></div></div>
          ...
          <section class="blog-area"><div class="container"><div class="blog-area-inner section-spacing"><div class="section-content"><div class="section-title-wrapper"><div class="title-wrapper"><h2 class="section-title has_fade_anim">Latest
                        StartupGrow
                        insights!</h2></div></div><div class="text-wrapper"><p class="text has_fade_anim">Ideas for websites, marketing, branding, and online growth for Indian startups.</p></div></div><div class="blogs-wrapper-box"><div class="blogs-wrapper has_fade_anim"><a href="/blog"><div class="blog-box"><div class="thumb"><img src="${onlineImages.collaborativeReview}" alt="Website development workflow"></div><div class="content"><span class="number">01</span><h3 class="title">Website <br>development</h3><span class="icon"><i class="fa-solid fa-arrow-right"></i></span></div></div></a><a href="/blog"><div class="blog-box"><div class="thumb"><img src="${onlineImages.growthDashboard}" alt="SEO analytics dashboard"></div><div class="content"><span class="number">02</span><h3 class="title">SEO <br>& strategy</h3><span class="icon"><i class="fa-solid fa-arrow-right"></i></span></div></div></a><a href="/blog"><div class="blog-box"><div class="thumb"><img src="${onlineImages.socialPlanning}" alt="Social media planning workspace"></div><div class="content"><span class="number">03</span><h3 class="title">Social media <br>growth</h3><span class="icon"><i class="fa-solid fa-arrow-right"></i></span></div></div></a></div></div></div></div></section>
