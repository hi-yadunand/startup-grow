        ...
        <main>
          ...
          <section className="team-area section-style section-item">
            <div className="container large"><div className="team-area-inner section-spacing"><div className="section-header"><div className="section-title-wrapper"><div className="title-wrapper"><h2 className="section-title has_fade_anim">Team members</h2></div></div><div className="text-wrapper"><p className="text has_fade_anim">StartupGrow was developed by a student team with guidance and support from faculty and institution.</p></div></div><div className="team-wrapper-box"><div className="team-wrapper">
              <div className="team-box"><div className="thumb"><a href="/team"><img src="/team-members/Yadunand%20Pavithran.jpg" alt="Yadunand Pavithran" /></a></div><div className="content"><div className="top"><h3 className="name"><a href="/team">Yadunand Pavithran</a></h3><p className="post">Team Member</p></div></div></div>
              <div className="team-box"><div className="thumb"><a href="/team"><img src="/team-members/Nashith%20Nihal%20C.jpeg" alt="Nashith Nihal C" /></a></div><div className="content"><div className="top"><h3 className="name"><a href="/team">Nashith Nihal C</a></h3><p className="post">Team Member</p></div></div></div>
              <div className="team-box"><div className="thumb"><a href="/team"><img src="/team-members/Gokul%20Krishna.jpeg" alt="Gokul Krishna" /></a></div><div className="content"><div className="top"><h3 className="name"><a href="/team">Gokul Krishna</a></h3><p className="post">Team Member</p></div></div></div>
            </div></div></div></div>
          </section>
