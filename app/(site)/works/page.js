    ...
    <div id="smooth-content">
      <div class="body-wrapper body-corporate-agency">
        ...
        <main>
          ...
          <section class="work-area"><div class="container"><div class="work-area-inner section-spacing-bottom"><div class="section-content"><div class="section-title-wrapper"><div class="title-wrapper"><h1 class="section-title large has_text_move_anim">Project</h1></div></div><div class="text-wrapper"><p class="text has_fade_anim"> StartupGrow is planned as a one-stop digital platform where Indian startups can explore services and request support.</p></div><div class="icon has_fade_anim"><img class="show-light" src="/assets/imgs/shape/img-s-82.webp" alt="image"><img class="show-dark" src="/assets/imgs/shape/img-s-82-light.webp" alt="image"></div></div><div class="works-wrapper-box"><div class="works-wrapper"><div class="has_fade_anim"><a href="#"><div class="work-box"><div class="thumb"><img src="/assets/imgs/works/img-s-12.webp" alt="work image"></div><div class="content"><h3 class="title">Website Development</h3><div class="meta"><span class="tag">StartupGrow - 2026</span></div></div></div></a></div><div class="has_fade_anim"><a href="#"><div class="work-box"><div class="thumb"><img src="/assets/imgs/works/img-s-13.webp" alt="work image"></div><div class="content"><h3 class="title">Branding System</h3><div class="meta"><span class="tag">StartupGrow - 2026</span></div></div></div></a></div><div class="has_fade_anim"><a class="large" href="#"><div class="work-box"><div class="thumb"><img src="/assets/imgs/works/img-s-14.webp" alt="work image"></div><div class="content"><h3 class="title">SEO Growth</h3><div class="meta"><span class="tag">StartupGrow - 2026</span></div></div></div></a></div><div class="has_fade_anim"><a href="#"><div class="work-box"><div class="thumb"><img src="/assets/imgs/works/img-s-15.webp" alt="work image"></div><div class="content"><h3 class="title">Social Campaign</h3><div class="meta"><span class="tag">StartupGrow - 2026</span></div></div></div></a></div><div class="has_fade_anim"><a href="#"><div class="work-box"><div class="thumb"><img src="/assets/imgs/works/img-s-16.webp" alt="work image"></div><div class="content"><h3 class="title">Request Module</h3><div class="meta"><span class="tag">StartupGrow - 2026</span></div></div></div></a></div></div></div></div></div></section>
