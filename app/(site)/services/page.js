      ...
      <div class="body-wrapper body-corporate-agency">
        ...
        <main>
          ...
          <section class="pricing-area"><div class="container"><div class="pricing-area-inner section-spacing"><div class="section-header"><div class="section-title-wrapper"><div class="title-wrapper"><h2 class="section-title has_text_move_anim">Special offer! choose
                        your growth pack today</h2></div></div></div><div class="pricing-wrapper-box"><div class="pricing-wrapper"><div class="pricing-box has_fade_anim" data-delay="0.15"><span class="tag">Basic</span><h3 class="price">₹849</h3><div class="feature-list"><ul><li><img class="show-light" src="/assets/imgs/icon/check-2.webp" alt="icon image"><img class="show-dark" src="/assets/imgs/icon/check-2-light.webp" alt="icon image">Landing page audit</li><li><img class="show-light" src="/assets/imgs/icon/check-2.webp" alt="icon image"><img class="show-dark" src="/assets/imgs/icon/check-2-light.webp" alt="icon image">Basic SEO setup</li><li><img class="show-light" src="/assets/imgs/icon/check-2.webp" alt="icon image"><img class="show-dark" src="/assets/imgs/icon/check-2-light.webp" alt="icon image">Contact form support</li></ul></div><a href="/contact" class="wc-btn wc-btn-primary btn-text-flip bordered"><span data-text="Learn More">Learn More</span></a></div><div class="pricing-box has_fade_anim" data-delay="0.30"><span class="tag">Standard</span><h3 class="price">₹2,749</h3><div class="feature-list"><ul><li><img class="show-light" src="/assets/imgs/icon/check-2.webp" alt="icon image"><img class="show-dark" src="/assets/imgs/icon/check-2-light.webp" alt="icon image">Website improvement plan</li><li><img class="show-light" src="/assets/imgs/icon/check-2.webp" alt="icon image"><img class="show-dark" src="/assets/imgs/icon/check-2-light.webp" alt="icon image">Social media setup</li><li><img class="show-light" src="/assets/imgs/icon/check-2.webp" alt="icon image"><img class="show-dark" src="/assets/imgs/icon/check-2-light.webp" alt="icon image">Content marketing plan</li></ul></div><a href="/contact" class="wc-btn wc-btn-primary btn-text-flip bordered"><span data-text="Learn More">Learn More</span></a></div><div class="pricing-box has_fade_anim" data-delay="0.45"><span class="tag">Premium</span><h3 class="price">₹6,499</h3><div class="feature-list"><ul><li><img class="show-light" src="/assets/imgs/icon/check-2.webp" alt="icon image"><img class="show-dark" src="/assets/imgs/icon/check-2-light.webp" alt="icon image">Web design and development</li><li><img class="show-light" src="/assets/imgs/icon/check-2.webp" alt="icon image"><img class="show-dark" src="/assets/imgs/icon/check-2-light.webp" alt="icon image">SEO and PPC campaign setup</li><li><img class="show-light" src="/assets/imgs/icon/check-2.webp" alt="icon image"><img class="show-dark" src="/assets/imgs/icon/check-2-light.webp" alt="icon image">Email and social growth</li></ul></div><a href="/contact" class="wc-btn wc-btn-primary btn-text-flip bordered"><span data-text="Learn More">Learn More</span></a></div></div></div></div></div></section>
